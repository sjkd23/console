import { IMappedAfkCheckReactions } from "../../types/reactions.js";
import { EmojiConstants } from "./EmojiConstants.js";
...
export const MAPPED_AFK_CHECK_REACTIONS: IMappedAfkCheckReactions = {
    ...
    VOID_KEY: {
        ...
        emojiInfo: {
            isCustom: true,
            identifier: "1001201297053192312"
        },
        name: "Void Key",
        isExaltKey: true
    },
    CULT_KEY: {
        ...
        emojiInfo: {
            isCustom: true,
            identifier: "1001201086503338105"
        },
        name: "Cult Key",
        isExaltKey: true
    },
...
/**
 * Get reaction information by mapKey
 */
export function getReactionInfo(mapKey: string) {
    return MAPPED_AFK_CHECK_REACTIONS[mapKey];
}

/**
 * Get emoji identifier for a given mapKey
 */
export function getReactionEmoji(mapKey: string): string | undefined {
    const reaction = MAPPED_AFK_CHECK_REACTIONS[mapKey];
    return reaction?.emojiInfo.identifier;
}
